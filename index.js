...
const ValueType = {
  "0": [
    "Purple Church Background",
    "Early Morning Ruins Background",
    "Black Night Ruins Background",
    "Dusk ruins background",
    "Early Morning Church Background",
    "Dark Night Church Background",
    "Green forest background",
    "Banquet room background",
    "War Background",
    "Black Bat Background",
    "Black Wolf Eyes Background",
    "Fuchsia background",
    "Yellow background",
    "Blue background",
    "Purple background",
  ...
  "7": [
    ...
    "purple slicked-back hair",
    "yellow slicked-back hair",
    "blue slicked-back hair",
    "White Stinger",
    "Pink Stinger",
    "Red curly hair",
    "Grey curly hair",
  ...
  "8": [
    ...
    "Blue Crown",
    "Purple Crown",
    "Yellow and green military cap",
    "Brown bowler hat",
    "Red duck tongue cap",
    "Blue duck tongue cap",
    "Transparent",
    "Coffee-colored bowler hat",
    "Brown duck tongue cap",
    "Green Bowler Hat",
    "Purple bowler hat"
  ],
  "9": [
    "Common Ears ",
    "Ordinary ears (with earrings)",
    "Missing ear (with earring)",
    "missing ear"
  ],
  "10": [
    "Silver Axe",
